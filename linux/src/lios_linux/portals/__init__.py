...
Untestable in this environment: every module needs a running `xdg-desktop-portal` (and, for
GlobalShortcuts/Background, a compositor backend for it) on the session bus, which `this machine`
does not have.
"""
