...
same clipboard entry (the clipboard investigation, section 6).
...
confirmed from here -- `this machine` has no display and no working search result settled it either.
