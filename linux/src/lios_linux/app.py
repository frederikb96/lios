...
a Wayland session for the clipboard -- none of which `this machine` has. Every module this file
...
class LiosApplication(Adw.Application):
    ...
    def _fetch_and_decode(self, item: ItemSummary) -> None:
        try:
            ...
            decoded = item_codec.open_sealed_item(group_key=group_key, sealed_blob=sealed)
        except Exception:
