...
/// never holds the group key (row order 0.2's whole point). This is this app's proposed
...
/// zero-open-taps-for-context experience Freddy asked for needs the relay and the Linux sender to
/// pick this up too.
