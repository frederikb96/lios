...
/// The in-app log every screen and background path writes to, and the log view (row order 2.8)
...
/// silently failed to arrive is ever diagnosable — Freddy sees the buffer, not a console. Kept as
