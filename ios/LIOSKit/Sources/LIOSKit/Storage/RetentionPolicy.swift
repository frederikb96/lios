...
/// Row order 0.3's policy, shared by both clients: keep the last N items for M days, then
/// expire. Configurable in the app, defaulting to what the spec settled on.
